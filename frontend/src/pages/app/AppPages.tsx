...
export default function AppPages() {
    ...
    return (
            ...
            <div>
                ...
                <div className="hidden lg:fixed lg:inset-y-0 z-50 lg:flex lg:w-48 lg:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                ...
                <div className="pl-[100px] lg:pl-48">
                    <div className="sticky top-0 z-50 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-6 shadow-sm sm:gap-x-6 lg:px-8">
